...
return [
    "sectionTitle" => "Weoll olarak, kurumunuzun iş ve iletişim süreçleri ihtiyaçlarınızı keşfetmenizi sağlıyoruz",
    "sectionSubTitle" => "Bu ihtiyaçlara en uygun dijital çözümleri seçebileceğiniz bir deneyim alanı açıyoruz",
    "tabs" => [
        [
            "title" => "Güçlü İnsan Kaynakları",
            "subtitle" => "Çalışan verimliliğini, motivasyonunu 
            ve bağlılığını artırarak çalışan 
            dönüşüm oranını düşürün.",
            "content" => [
                "Çalışan Başlılığı",
                "Kapsayıcı İletişim ve Çalışma Alanı",
                "Performans Yönetimi",
